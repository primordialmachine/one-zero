...
#include "primordialmachine/one_zero_functors/golden_ratio_expression.hpp"
#include "primordialmachine/one_zero_functors/value_of_expression.hpp"

namespace primordialmachine {

template<>
struct value_of_expression<float, golden_ratio_expression, void>
{
...
template<>
struct value_of_expression<double, golden_ratio_expression, void>
{
...
template<>
struct value_of_expression<long double, golden_ratio_expression, void>
{
