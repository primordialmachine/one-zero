...
template<>
struct value_of_expression<float, pi_expression, void>
{
...
template<>
struct value_of_expression<double, pi_expression, void>
{
...
template<>
struct value_of_expression<long double, pi_expression, void>
{
